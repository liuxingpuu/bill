...
type (
	...
	User struct {
		...
		LastActiveTime time.Time `db:"last_active_time"` // 上一次活跃时间
	}
)
...
func (m *defaultUserModel) Insert(ctx context.Context, data *User) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Mobile, data.Password, data.Email, data.Nickname, data.Avatar, data.LastActiveTime)
...
func (m *defaultUserModel) Update(ctx context.Context, data *User) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Mobile, data.Password, data.Email, data.Nickname, data.Avatar, data.LastActiveTime, data.Id)
	}, userEmailKey, userIdKey, userMobileKey)
	return err
}
